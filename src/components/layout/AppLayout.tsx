                ...
                <AuthGuard>
                    {!isApproved ? (
                        <div className="container mx-auto max-w-xl h-[80vh] flex flex-center items-center px-4">
                            <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-blue-900/5 text-center space-y-6 w-full animate-in zoom-in-95 duration-500">
                                ...
                                <div className="space-y-2">
                                    <h2 className="text-2xl font-black text-gray-900 italic tracking-tighter transform -skew-x-6 uppercase">HESABINIZ ONAY BEKLİYOR</h2>
                                ...
                                <div className="pt-4 flex flex-col gap-2">
                                    <button
                                        ...
                                        className="w-full h-12 bg-gray-50 hover:bg-gray-100 text-gray-600 font-black rounded-xl border border-gray-200 uppercase tracking-widest text-xs transition-all"
                                    >
                                        DURUMU KONTROL ET
                                    </button>
